<?php 
 ...
 if (isset($_GET['kode_pembelian'])) {
    // Ambil nilai 'kode_pembelian' dari URL
    $kode_pembelian = $_GET['kode_pembelian'];

    // Panggil fungsi cetak_pembelian
    cetak_pembelian($kode_pembelian);
} else {
    echo "Parameter 'kode_pembelian' tidak ditemukan.";
}
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pengguna as $pgn) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $pgn["kode_pembelian"]; ?></td>
                                    ...
                                    <!-- <td class="text-center">
                                        ...
                                        <a class="btn btn-warning" href="../laporan/fungsi_laporan.php?kode_pembelian=<?= $pgn["kode_pembelian"]; ?>" role="button"><i class="fas fa-edit"></i>Cetak</a>|
                                    </td> -->
                                </tr>
