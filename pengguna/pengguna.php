...
?>
                    <a  class="btn btn-outline-primary" href="../pengguna/tambah_pengguna.php" >tambah data pengguna</a> 
                            ...
                            <?php foreach ($pengguna as $pgn) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger" href="../pengguna/hapus_pengguna.php?id_pegawai=<?=$pgn["id_pegawai"]; ?>" onclick="return confirm('apakah anda yakin')" role="button"><i class="fas fa-trash">
                                                </i>hapus</a>|
                                        <a class="btn btn-warning" href="../pengguna/edit_pengguna.php?id_pegawai=<?= $pgn["id_pegawai"]; ?>" role="button"><i class="fas fa-edit"></i>edit</a>|
                                    </td>
                                </tr>
