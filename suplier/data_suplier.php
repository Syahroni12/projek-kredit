...
?>
                    <a  class="btn btn-outline-primary" href="../suplier/tambah_suplier.php" >tambah data suplier</a> 
                            ...
                            <?php foreach ($suplier as $spr) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-warning" href="../suplier/edit_suplier.php?id_suplier=<?= $spr["id_suplier"]; ?>" role="button"><i class="fas fa-edit"></i>edit</a>|
                                    </td>
                                </tr>
