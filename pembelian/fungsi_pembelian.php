...
function tambah_data($data)
{
    ...
    $tanggal_input = htmlspecialchars($data["tgl_pembelian"]);
    ...
    $query = "INSERT INTO pembelian(kode_barang,tgl_pembelian,nama_toko,alamat_toko)
    VALUES
    ('$id_barang','$tanggal_input','$nama_toko','$alamat_toko')";
