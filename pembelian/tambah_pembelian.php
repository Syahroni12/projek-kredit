<?php 
  ...
  if (tambah_data($_POST)>0) {
      ...
      header("Location:../pembelian/tahap_awal.php");
  }else {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <a  class="btn btn-outline-danger mb-4" href="../pembelian/tahap_awal.php" >Kembali</a> 
...
?>
            ...
            <option value="<?= $jnb['kode_barang'] ?>"><?= $jnb['nama_barang'] ?></option>
            <?php } ?>
 
        </select>

<!-- <div class="form-group">
<input type="text" class="form-control"name="harga_jual" id="harga_jual" oninput="formatCurrency(this)"placeholder="Masukkan Harga Beli"required>
 </div>  -->
...
<input type="text" class="form-control" id="alamat_toko"name="alamat_toko" placeholder="Masukkan Alamat Toko"required>
</div>
