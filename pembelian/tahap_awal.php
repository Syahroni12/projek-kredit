...
?>
<a  class="btn btn-outline-primary" href="../pembelian/tambah_pembelian.php" >Tambah Data Pembelian</a>
                                        <table class="table table-bordered">


                    <?php
                    require '../pembelian/fungsi_pembelian.php';
                     global $conn;
                        $pengguna = query("select * from pembelian");
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pengguna as $pgn) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $pgn["kode_barang"]; ?></td>
                                    <td class="text-center"><?= $pgn["tgl_pembelian"]; ?></td>
                                    <td class="text-center"><?= $pgn["nama_toko"]; ?></td>
                                    <td class="text-center"><?= $pgn["alamat_toko"]; ?></td>
                                    
                                    <td class="text-center">
                                        <a class="btn btn-danger" href="../pembelian/fungsi_pembelian.php?kode_pembelian=<?=$pgn["kode_pembelian"]; ?>" onclick="return confirm('apakah anda yakin')" role="button"><i class="fas fa-trash">
                                                </i>hapus</a>|
                                        <a class="btn btn-warning" href="../pembelian/fungsi_pembelian.php?kode_pembelian=<?= $pgn["kode_pembelian"]; ?>" role="button"><i class="fas fa-edit"></i>edit</a>|
                                    </td>
                                </tr>
